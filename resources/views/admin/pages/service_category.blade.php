...
@section('content')
                                            ...
                                            <td>
                                                <div class="button-list">
                                                    <button type="button"
                                                            ...
                                                            data-bs-target="#details_{{ $service_category->id }}"
                                                            data-bs-toggle="modal"
                                                    >
                                                        Details
                                                    </button>
                                                    ...
                                                    <button type="button" class="btn btn-info waves-effect waves-light"
                                                            data-bs-target="#edit_{{ $service_category->id }}"
                                                            data-bs-toggle="modal"
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            data-bs-target="#delete_{{ $service_category->id }}"
                                                            data-bs-toggle="modal"
                                                    >
                                                        Delete
                                                    </button>
    ...
    @include('admin.inclouds.services_category_modals')
