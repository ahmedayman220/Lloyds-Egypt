...
@section('content')
            ...
            <div class="card">
                <div class="card-body ">
                    <div class="d-flex justify-content-between align-items-center  mb-4">
                        <h4 class="header-title">Supplier Category</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="key-datatable"
                                    ...
                                    <tbody>
                                    @forelse($suppliers_category as $supplier_category)
                                        <tr class="even">
                                            ...
                                            <td>
                                                <div class="button-list">
                                                    <button type="button"
                                                            ...
                                                            data-bs-target="#details_{{ $supplier_category->id }}"
                                                            data-bs-toggle="modal"
                                                    >
                                                        Details
                                                    </button>
                                                    ...
                                                    <button type="button" class="btn btn-info waves-effect waves-light"
                                                            data-bs-target="#edit_{{ $supplier_category->id }}"
                                                            data-bs-toggle="modal"
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            data-bs-target="#delete_{{ $supplier_category->id }}"
                                                            data-bs-toggle="modal"
                                                    >
                                                        Delete
                                                    </button>
    ...
    @include('admin.inclouds.suppliers_category_modals')
