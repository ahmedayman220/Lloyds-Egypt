...
@section('content')
            ...
            <div class="card">
                <div class="card-body ">
                    <div class="d-flex justify-content-between align-items-center  mb-4">
                        <h4 class="header-title">Supplier Items</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="key-datatable"
                                    ...
                                    <tbody>
                                    @forelse($suppliers_items as $supplier_item)
                                        <tr class="even">
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $supplier_item->name }}</td>
                                            <td>{{ $supplier_item->supplierCategory->name }}</td>
                                            <td>
                                                <div class="button-list">
                                                    <button type="button"
                                                            class="btn btn-success waves-effect waves-light"
                                                            data-bs-target="#details_{{ $supplier_item->id }}"
                                                            data-bs-toggle="modal"
                                                    >
                                                        Details
                                                    </button>
                                                    ...
                                                    <button type="button" class="btn btn-info waves-effect waves-light"
                                                            data-bs-target="#edit_{{ $supplier_item->id }}"
                                                            data-bs-toggle="modal"
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            data-bs-target="#delete_{{ $supplier_item->id }}"
                                                            data-bs-toggle="modal"
                                                    >
                                                        Delete
                                                    </button>
    ...
    @include('admin.inclouds.supplier_item_modals')
