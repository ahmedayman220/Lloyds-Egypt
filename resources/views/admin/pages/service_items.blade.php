...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="key-datatable"
                                    ...
                                    <tbody>
                                    @forelse($services_items as $service_item)
                                        <tr class="even">
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $service_item->name }}</td>
                                            <td>{{ $service_item->serviceCategory->name }}</td>
                                            <td>
                                                <div class="button-list">
                                                    <button type="button"
                                                            class="btn btn-success waves-effect waves-light"
                                                            data-bs-target="#details_{{ $service_item->id }}"
                                                            data-bs-toggle="modal"
                                                    >
                                                        Details
                                                    </button>
                                                    ...
                                                    <button type="button" class="btn btn-info waves-effect waves-light"
                                                            data-bs-target="#edit_{{ $service_item->id }}"
                                                            data-bs-toggle="modal"
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            data-bs-target="#delete_{{ $service_item->id }}"
                                                            data-bs-toggle="modal"
                                                    >
                                                        Delete
                                                    </button>
    ...
    @include('admin.inclouds.services_item_modals')
